...
label1=Label(root,text='Temperture in Celcius =',font=('Arial',25),bg='pink')
label1.place(x=200,y=200)

label2=Label(root,text='Temperture in Fahrenheit =',font=('Arial',25),bg='pink')
...
def click1():
        label3.config(text='' +str(var1.get() * 1.8 +    32)+ ' °F',bg='light green')

button1=Button(root,text='Convert',font=('Arial',25),command=click1)
button1.place(x=920,y=200)

label4=Label(root,text='Temperture in Fahrenheit =',font=('Arial',25),bg='orange')
label4.place(x=200,y=400)
label5=Label(root,text='Temperture in Celcius =',font=('Arial',25),bg='orange')
...
def click2():
        label6.config(text='' +str((var2.get()-32)/1.8)+ ' °C',bg='light green')
